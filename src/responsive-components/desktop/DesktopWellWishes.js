...
const DesktopWellWishes = () => {
  ...
  return (
    <div className="Well-wishes-desktop create" style={{ backgroundImage: "url(/wellwishesphoto.jpg)", backgroundPosition: 'left 35% bottom',
...
export default DesktopWellWishes;