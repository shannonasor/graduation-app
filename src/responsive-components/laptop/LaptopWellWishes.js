...
const LaptopWellWishes = () => {
  ...
  return (
    <div className="Well-wishes-laptop create" style={{ backgroundImage: "url(/wellwishesphoto.jpg)", backgroundPosition: 'left 35% bottom',
...
export default LaptopWellWishes;